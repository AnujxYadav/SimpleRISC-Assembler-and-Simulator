...
reg_list=["0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000"]
...
def printing(): 
    print(pc,reg_list[0],reg_list[1],reg_list[2],reg_list[3],reg_list[4],reg_list[5],reg_list[6],reg_list[7])
...
while True:
    ...
    if bin[pc][0:5]=='00000': #addition instruction
        ...
        if(reg1_value>65535): #checking condition for overflow
            reg_list[reg1]=format(reg1_value,'#018b')[-16:] # extra bit ignored
    ...
    # Type C instructions begin
        ...
        reg2_value=int(reg_list[reg2],2)
        reg1_value=int(reg_list[reg1],2)
        quotient = reg1_value/reg2_value
        remainder = reg1_value%reg2_value
